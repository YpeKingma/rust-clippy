...
pub mod ltbnr_mod {
    ...
    use super::{LifetimesBoundNestedRef, EXPLICIT_LIFETIMES_BOUND, IMPLICIT_LIFETIMES_BOUND};
    ...
    /// From a [`Generics`] provide an [`FxHashMap`] of the declared lifetime symbols to their
    /// spans.
    ...
    /// From a [`Generics`] provide a [`BTreeMap`] of the declared lifetime bounds to the spans of
    /// the declarations.
