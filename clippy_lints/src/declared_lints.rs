...
pub(crate) static LINTS: &[&crate::LintInfo] = &[
    ...
    crate::lifetimes_bound_nested_ref::ADD_REDUNDANT_LIFETIMES_BOUND_NESTED_REF_ARG_INFO,
    crate::lifetimes_bound_nested_ref::REMOVE_REDUNDANT_LIFETIMES_BOUND_NESTED_REF_ARG_INFO,
